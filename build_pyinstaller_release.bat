...
echo.
echo ╔══════════════════════════════════════════════════════════════╗
echo ║        🚀 MACRO AUTO - BUILD RELEASE (PYINSTALLER)           ║
echo ║           Production build - NO console (for end users)      ║
echo ╚══════════════════════════════════════════════════════════════╝
echo.
...
echo ║  🎯 Mode: RELEASE (không có console - dành cho user)
echo ║  ✅ Features:
...
echo    3. Icon file exists: %ICON_FILE%
echo ══════════════════════════════════════════════════════════════
